...
cell10 = tf.summary.scalar('cell10_summary', lstm_state[0][-1][10])
cell11 = tf.summary.scalar('cell11_summary', lstm_state[0][-1][11])
cell12 = tf.summary.scalar('cell12_summary', lstm_state[0][-1][12])
cell13 = tf.summary.scalar('cell13_summary', lstm_state[0][-1][13])
cell14 = tf.summary.scalar('cell14_summary', lstm_state[0][-1][14])
cell15 = tf.summary.scalar('cell15_summary', lstm_state[0][-1][15])
cell16 = tf.summary.scalar('cell16_summary', lstm_state[0][-1][16])
cell17 = tf.summary.scalar('cell17_summary', lstm_state[0][-1][17])
cell18 = tf.summary.scalar('cell18_summary', lstm_state[0][-1][18])
cell19 = tf.summary.scalar('cell19_summary', lstm_state[0][-1][19])
...
with tf.Session() as sess:
    file_writer = tf.summary.FileWriter('Cell_States_Part_4')
...
# Getting Cell States Summary for k=15
    ...
    seq_in = test_sequence[0:2 * k_test + 1]
    out_char = ''
    out_seq = ''
    cnt = 0
